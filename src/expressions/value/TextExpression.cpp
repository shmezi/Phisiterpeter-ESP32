...
std::shared_ptr<BaseExpression> TextExpression::interpret(std::shared_ptr<Scope> scope) {
...
std::shared_ptr<BaseExpression> TextExpression::addition(std::shared_ptr<BaseExpression> &&expression,
