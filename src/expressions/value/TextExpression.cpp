...
std::unique_ptr<Expression> TextExpression::interpret(std::shared_ptr<Scope> scope) {
...
std::unique_ptr<Expression> TextExpression::addition(std::unique_ptr<Expression> &&expression,
