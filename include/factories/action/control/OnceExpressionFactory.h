...
#ifndef PHISITERPETER_ESP32_ONCEEXPRESSIONFACTORY_H
#define PHISITERPETER_ESP32_ONCEEXPRESSIONFACTORY_H
#include "factories/Factory.h"


class OnceExpressionFactory : public Factory{
public:
...
#endif //PHISITERPETER_ESP32_ONCEEXPRESSIONFACTORY_H