...
#ifndef PHISITERPETER_ESP32_ABSEXPRESSIONFACTORY_H
#define PHISITERPETER_ESP32_ABSEXPRESSIONFACTORY_H
#include "factories/Factory.h"


class AbsExpressionFactory : public Factory {
public:
...
#endif //PHISITERPETER_ESP32_ABSEXPRESSIONFACTORY_H